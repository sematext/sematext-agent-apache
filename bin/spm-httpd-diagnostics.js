 ...
 *
 * @licence SPM for Apache2/httpd is free-to-use, proprietary software.
...
var cfgDumpFileName = path.join(os.tmpdir(), 'sematext-agent-httpd-diagnostics.json')
...
var archFileName = path.join(os.tmpdir(), 'sematext-agent-httpd-diagnostics.zip')
zip.writeZip(archFileName)
console.log('Sematext Agent Httpd diagnostics info is in:  ' + archFileName)
